...
#'   \item{TIME}{The time, from 00:00 to 23:00 each day}
...
#' obtained from the Banco de Dados Meteorológicos (BDMEP).
#' Data collected from an automatic weather station in Brasília
